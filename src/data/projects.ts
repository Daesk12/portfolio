...
export const projects: Project[] = [
  ...
  },
  {
    ...
    ddescription: {
      ...
      Un día mientras que Xoldarg andaba en el parque veía a los niños jugar y ser felices por lo que él también quería apoyarlos. Decidido comprar una pistola de burbujas y una varita
      mágica que hasta el día de hoy conserva ya que con estos al menos no es completamente rechazado por las personas.
      ...
      -Antonio: El unico y mejor amigo de Xoldarg ese que está en las buenas y en las malas
      para él y que es como un hermano para nuestro protagonista pese a su peculiar forma.`,
      en: ``,
    },
  },
  {
  ...
  },
  {
    ...
    ddescription: {
      es: `El naming del proyecto surge de como yo (nos) cambió para encajar en un otros que nunca se termina de consolidar, de todos esos cambios que tengo que hacer en mi para poder encajar con el resto y que finalmente me hace perder lo más importante de mi, mi identidad, por ello el tachado en el nos y el otros que es cambiante, con letras que nunca encajan perfectamente y que siempre están en constante cambio.
